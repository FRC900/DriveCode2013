 ...
 */
public class IndexedEncoder extends SensorBase implements CounterBase, PIDSource, ISensor, LiveWindowSendable {

    public static class PIDSourceParameter {
        public final int value;
        static final int kDistance_val = 0;
        static final int kRate_val = 1;
        public static final IndexedEncoder.PIDSourceParameter kDistance = new IndexedEncoder.PIDSourceParameter(kDistance_val);
        public static final IndexedEncoder.PIDSourceParameter kRate = new IndexedEncoder.PIDSourceParameter(kRate_val);
    ...
    private IndexedEncoder.PIDSourceParameter m_pidSource;
     ...
     */
    public IndexedEncoder(final int aSlot, final int aChannel,
     ...
     * if necessary so forward represents positive values.
     */
    public IndexedEncoder(final int aChannel, final int bChannel, boolean reverseDirection) {
        m_allocatedA = true;
        m_allocatedB = true;
        m_allocatedI = false;
     ...
     * @param bChannel The b channel digital input channel.
     */
    public IndexedEncoder(final int aChannel, final int bChannel) {
     ...
     * or be double (2x) the spec'd count.
     */
    public IndexedEncoder(final int aChannel, final int bChannel, boolean reverseDirection, final EncodingType encodingType) {
        m_allocatedA = true;
        m_allocatedB = true;
        m_allocatedI = false;
        if (encodingType == null)
     ...
     * @param indexChannel The index channel digital input channel.
     */
    public IndexedEncoder(final int aChannel, final int bChannel, final int indexChannel) {
     ...
     * if necessary so forward represents positive values.
     */
    public IndexedEncoder(DigitalSource aSource, DigitalSource bSource, boolean reverseDirection) {
        m_allocatedA = false;
        m_allocatedB = false;
        m_allocatedI = false;
        if (aSource == null)
     ...
     * @param bSource the source that should be used for the b channel.
     */
    public IndexedEncoder(DigitalSource aSource, DigitalSource bSource) {
     ...
     * or be double (2x) the spec'd count.
     */
    public IndexedEncoder(DigitalSource aSource, DigitalSource bSource, boolean reverseDirection, final EncodingType encodingType) {
        m_allocatedA = false;
        m_allocatedB = false;
        m_allocatedI = false;
        if (encodingType == null)
     ...
     */
    public void setPIDSourceParameter(IndexedEncoder.PIDSourceParameter pidSource) {
    ...
    public double pidGet() {
        ...
        case IndexedEncoder.PIDSourceParameter.kDistance_val:
            return getDistance();
        case IndexedEncoder.PIDSourceParameter.kRate_val:
            return getRate();
        default:
            return 0.0;
        }
    ...
    public void setIndex(boolean on) {
        if (on) {
            m_encoder.writeConfig_IndexSource_AnalogTrigger(true);
        } else {
            m_encoder.writeConfig_IndexSource_AnalogTrigger(true);
        }
        //m_encoder.writeConfig_IndexSource_AnalogTrigger(m_indexSource.getAnalogTriggerForRouting());
